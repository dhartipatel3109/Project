        ...
        <div class="container-login100">
                ...
                <form class="login100-form" action="" method="post">
                    ...
                    <div class="container">
                        <div class="container-login100-form-btn" style="justify-content: center;">
                            <button type="submit" method="post" action="/checkAdmin" class="login100-form-btn btn-margin">
                                LOGIN
                            </button>
                        </div>
                    </div>
                   ...
                   <div class="w-full">
                        <button type="button" class="d-flex btn btn-outline-info" style="margin: 0 auto;">
                            <a href="#">
                                <span class="mx-1"><img src="../public/programs/form/assets/images/google.svg" alt="google-logo" width="20" height="20"></span>
                    <span>Google</span>
                    </a>
                    </button>
            </div>
            ...
            <div class="flex-sb-m w-full p-t-5 m-l-30" style="justify-content: center;">
                <div>
                    ...
                    <a href="../user/SignUp.html" class="text-primary font-weight-bold">
                        Sign Up
                    </a>
                </div>
                </form>
