        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-xl-11 d-flex align-items-center">
                    <h1 class="logo mr-auto"><a href="index.html">UML CMS</a></h1>
                    <nav class="nav-menu d-none d-lg-block">
                        <ul>
                            <li class="active"><a href="user/Login.jsp">Home</a></li>
                    ...
                    <div class="carousel-item" style="background-image: url(public/main_assets/img/intro-carousel/2.jpg)">
                        <div class="carousel-container">
                            <div class="container">
                                ...
                                <a href="user/Login.html" class="btn-get-started scrollto animate__animated animate__fadeInUp">Register</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item" style="background-image: url(public/main_assets/img/intro-carousel/3.jpg)">
                        <div class="carousel-container">
                            <div class="container">
                                ...
                                <a href="user/Login.html" class="btn-get-started scrollto animate__animated animate__fadeInUp">Get Started</a>
                            </div>
                        </div>
                    </div>
